...
__turbopack_context__.v({"header":{"logo":"/logo.png","logoMini":"/favicon-vasto-imperio.ico","links":[{"label":"Home","url":"/"},{"label":"Produtos","url":"/produtos"},{"label":"Sobre Nós","url":"/sobre-nos"},{"label":"Contacto","url":"/contacto"}]},"homeHeader":{"background":"/Background.png","tools":"/tools.png","text":[{"title":"SOLUÇÕES PARA ORGANIZAR","subTitle":"Veja as nossas soluções para organizar o seu negócio.","button":"Ver Produtos","url":"/produtos"}]},"homeCards":{"text":[{"icon":"TbTruckDelivery","title":"Entregas em todo o país.","subTitle":"Envios rápidos graças a stock permanente disponível."},{"icon":"FaMapMarkedAlt","title":"Vários centros em Portugal.","subTitle":"Encontre o nosso armazém em Viseu ou na Benedita."},{"icon":"MdOutlineWorkspacePremium","title":"Acompanhamento profissional.","subTitle":"Apoio especializado antes e após a entrega."},{"icon":"FaRankingStar","title":"Qualidade e fiabilidade.","subTitle":"Soluções robustas, prontas para uso imediato."}]}});}),
...
"[project]/components/home/InfoIconsCards.jsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/home/InfoIconsCards.jsx'\n\nExpected ';', '}' or <eof>");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54c1d0fa._.js.map