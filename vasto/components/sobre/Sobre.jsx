...
function Sobre() {
  ...
  return (
    <div className="text-medium border-bm-auto border-(--horizontal-line) mb-20">
      ...
      <div className="flex py-15 flex-col gap-5 m-auto">
        <div className="flex flex-col text-justify md:flex-row max-w-250 m-auto">
            <div className="max-w-200 m-auto px-5">
              <p className="text-(--orange) text-left font-black text-[1.2em]">{item.p1t}</p>
              <p>{item.p1}</p>
              <br />
              <p className="text-(--blue) text-left font-black text-[1.2em]">{item.p2t}</p>
              <p>{item.p2}</p>
            </div>
            <Image
              src={logo}
        ...
        <div className="flex gap-5 text-center items-center justify-center text-[5em] md:text-[10em] lg:text-[13em] font-black bg-(--gray)">
        ...
        <div className="max-w-250 py-10 text-justify m-auto px-5">
          <p className="text-(--orange) font-black text-left text-[1.2em]">{item.p3t}</p>
          <p>{item.p3}</p>
          <br />
          <p className="text-(--blue) font-black text-left text-[1.2em]">{item.p4t}</p>
          <p>{item.p4}</p>
        </div>
      </div>
    </div>
