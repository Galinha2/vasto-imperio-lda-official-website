  ...
  return (
    <div className="text-medium border-bm-auto w-screen border-(--horizontal-line) mb-20">
      ...
      <div className="flex py-15 flex-col gap-5 m-auto">
        <div className="flex flex-col text-justify md:flex-row max-w-200 m-auto">
            <div className="max-w-200 m-auto px-5">
              <p className="text-(--orange) text-justify font-black text-[1.2em]">{item.p1t}</p>
              <p>{item.p1}</p>
              <br />
        ...
        <div className="max-w-200 py-10 text-justify m-auto px-5">
